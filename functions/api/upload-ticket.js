 ...
 * Validate auth, create job stub, return upload instructions
 *
 * The technician uploads photos via POST /api/upload (multipart form-data)
 * This endpoint just creates the job record and returns the job ID.
 */
